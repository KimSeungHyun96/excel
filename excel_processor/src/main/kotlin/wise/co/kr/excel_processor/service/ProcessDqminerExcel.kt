...
//        val sourceSheet2 = sourceWorkbook.getSheet("(룰설정)도메인") ?: throw IllegalArgumentException("Sheet 2 not found")
        ...
        // "점검시스템명 : DQMINER# ( GTONE )"에서 "DQMINER"만 추출
        val diagnosisToolName = sourceSheet0.getRow(1).getCell(1).stringCellValue
        val extractedToolName = diagnosisToolName.substringAfter("점검시스템명 : ").substringBefore("#")

        // 추출된 값을 dataHashMap0에 저장
        dataHashMap0["진단도구명"] = extractedToolName
